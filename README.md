# Movie Browser - React Query v5 + TMDB API

Aplikacja Vite + React + TypeScript pobierająca prawdziwe dane z TMDB API.
...
W pliku `.env` wpisz klucz TMDB v3:
...
- Popularne filmy i wyszukiwanie przez TMDB API.
...
- MSW: mock HTTP 401 dla TMDB, wywołujący `ErrorBanner` w aplikacji.
